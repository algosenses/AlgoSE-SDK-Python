...
class TimerService : public ServiceBase
{
public:
...
class SecurityDefinitionService : public ServiceBase
{
protected:
...
class MarketDataService : public ServiceBase
{
public:
...
class ExecutionService : public ServiceBase
{
public:
    // Reenterable and thread-safe must be guaranteed by implementor.
...
class HistoricalDataService : public ServiceBase
{
public:
...
class AlertService : public ServiceBase
{
public:
