...
public:
    ...
    public:
        virtual ~TradingAPI() {}
        virtual bool buy(const char* instrument, double quantity, double price, char* clOrdId, int srvId = 0) = 0;
        virtual bool sell(const char* instrument, double quantity, double price, char* clOrdId, int srvId = 0) = 0;
        virtual bool sellShort(const char* instrument, double quantity, double price, char* clOrdId, int srvId = 0) = 0;
        virtual bool buyToCover(const char* instrument, double quantity, double price, char* clOrdId, int srvId = 0) = 0;
        virtual bool cancelOrder(const char* _clOrdId) = 0;
