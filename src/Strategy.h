...
protected:
    ...
    bool   algoBuy(const char* instrument, double quantity, double price, const AlgoParams* params, char* clOrdId, int srvId = 0);
    bool   algoSell(const char* instrument, double quantity, double price, const AlgoParams* params, char* clOrdId, int srvId = 0);
    bool   algoSellShort(const char* instrument, double quantity, double price, const AlgoParams* params, char* clOrdId, int srvId = 0);
    bool   algoBuyToCover(const char* instrument, double quantity, double price, const AlgoParams* params, char* clOrdId, int srvId = 0);
