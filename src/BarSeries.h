...
class TickSeries : public SequenceDataSeries<Tick>
{
public:
    TickSeries(int maxLen = DEFAULT_MAX_LEN);
...
class BarSeries : public SequenceDataSeries<Bar>
{
public:
    // @param: maxLen: The maximum number of values to hold.
    // Once a bounded length is full, when new items are added, a corresponding number of items are discarded from the opposite end.
    BarSeries(int maxLen = DEFAULT_MAX_LEN);
